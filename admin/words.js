...
"Debug & Erweiterte Optionen": {
  ...
  "showLastOrFirstNap": {
    ...
    "es": "Mostrar la última o la primera siesta (true = última, false = primera)",
    "pl": "Pokaż ostatnią lub pierwszą drzemkę (true = ostatnia, false = pierwsza)",
    "zh-cn": "显示最后或第一次小睡（true=最后，false=第一次）"
  },
  "clearNapListAtNight": {
    ...
    "pl": "Automatycznie usuń listę drzemek w nocy",
    "zh-cn": "夜间自动清除小睡列表"
  },
  "enableDailyNapClear": {
    ...
    "pl": "Włącz codzienne czyszczenie listy drzemek",
    "zh-cn": "启用每日小睡列表清理"
  },
